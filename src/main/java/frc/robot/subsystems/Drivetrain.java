...
public class Drivetrain extends Subsystem {
        ...
        private final SwerveModule frontLeftModule = new Mk2SwerveModuleBuilder(
                ...
                .angleMotor(new TalonSRX((2), Mk2SwerveModuleBuilder.MotorType.MINI_CIM))
                .driveMotor(new TalonSRX((1), Mk2SwerveModuleBuilder.MotorType.CIM))   
                .build();
        ...
        private final SwerveModule frontRightModule = new Mk2SwerveModuleBuilder(
                ...
                .driveMotor(new TalonSRX((3), Mk2SwerveModuleBuilder.MotorType.CIM))
                .build();
        private final SwerveModule backLeftModule = new Mk2SwerveModuleBuilder(
                new Vector2(-TRACKWIDTH / 2.0, WHEELBASE / 2.0))
                .angleEncoder(new AnalogInput(RobotMap.DRIVETRAIN_BACK_LEFT_ANGLE_ENCODER), BACK_LEFT_ANGLE_OFFSET)
                .angleMotor(new TalonSRX((6), Mk2SwerveModuleBuilder.MotorType.MINI_CIM))
        ...
        private final SwerveModule backRightModule = new Mk2SwerveModuleBuilder(
                ...
                .angleMotor(new TalonSRX((8), Mk2SwerveModuleBuilder.MotorType.MINI_CIM))
                .driveMotor(new TalonSRX((7), Mk2SwerveModuleBuilder.MotorType.CIM))
                .build();
